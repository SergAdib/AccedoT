...
export function carouselBuilder(obj, counter) {

  // Start building carousel items scheme
  let tags ='';
  for (var i=0; i < counter; i++) {
    tags += '<div class="item ' + obj[i].active
         + '"><div class="col-xs-12 col-sm-4 col-md-2">'
         + '<a href="#' + i + '" onclick="expand(this);"><img src="' + obj[i].images[0].url
         + '" class="img-responsive" alt="' + obj[i].images[0].type
         + '" title="' + obj[i].title + '"></a>'
         + '<div class="itemcaption"><h3>' + obj[i].title
         + '</h3></div></div></div>'
         + '<!-- End of ' + i + ' slide tag -->';
  }
